...
public final class WhatIsNewInCollectors
{
  ...
  /**
   * Example call to new method {@link Collectors#toUnmodifiableMap(Function, Function)}.
   * @since 10
  ...
  /**
   * Example call to new method {@link Collectors#toUnmodifiableMap(Function, Function, BinaryOperator)}.
   * @since 10
